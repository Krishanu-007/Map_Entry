...
# Retrieve MongoDB URI from environment variable (no fallback needed)
...
# API endpoint to fetch location data by common_id (updated to return a series of coordinates)
